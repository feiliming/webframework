...
<body>
	...
	<div id="index_layout">
		<div data-options="region:'north'" style=" overflow: hidden;" id="header">
    		...
    		<span class="header"><h2>吉林省组织机构代码电子商务交易信用服务信息平台</h2></span>
		</div>
		...
		<div data-options="region:'south',border:false" style="height: 30px;padding-top:5px; overflow: hidden;text-align: center;background-color: #daeef5" >@吉林省组织机构代码电子商务交易信用服务信息平台</div>
	</div>
